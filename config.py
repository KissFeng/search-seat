...
AUTO_SYNC_RESERVES_ENABLED = get_env("AUTO_SYNC_RESERVES_ENABLED", "1").lower() in ("1", "true", "yes")
AUTO_SYNC_START_HOUR = get_int_env("AUTO_SYNC_START_HOUR", 8)
AUTO_SYNC_END_HOUR = get_int_env("AUTO_SYNC_END_HOUR", 23)
AUTO_SYNC_INTERVAL_MINUTES = get_int_env("AUTO_SYNC_INTERVAL_MINUTES", 15)
